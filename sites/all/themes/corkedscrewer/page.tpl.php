...
<div class="slider-item-image"><img src="<?php print base_path() . drupal_get_path('theme', 'corkedscrewer') ;?>/images/local/slider-img4.jpg"/></div>
<div class="slider-item-title">Beach Hideaways</div>
<div class="slider-item-body">Discover secret beaches around the world</div>
</div>
<!--EOF:slider-item-->
...
<div class="slider-item-title light">Discover European Cuisine</div>
<div class="slider-item-body">French Restaurants</div>
</div>
<!--EOF:slider-item-->

<!--slider-item-->
<div class="slider-item">
<div class="slider-item-image"><img src="<?php print base_path() . drupal_get_path('theme', 'corkedscrewer') ;?>/images/local/road.jpg"/></div>
<div class="slider-item-title light">Road Trippin'</div>
<div class="slider-item-body">Best routes</div>
</div>
<!--EOF:slider-item-->

<!--slider-item-->
<div class="slider-item">
<div class="slider-item-image"><img src="<?php print base_path() . drupal_get_path('theme', 'corkedscrewer') ;?>/images/local/kayak.jpg"/></div>
<div class="slider-item-title">Activities </div>
<div class="slider-item-body">Have fun</div>
</div>
<!--EOF:slider-item-->
</div>
<!--EOF:slides-->
